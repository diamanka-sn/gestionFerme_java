...
public class ItemDiagramme extends javax.swing.JPanel {

    private final ModelDiagramme data;

    public ItemDiagramme(ModelDiagramme data) {
        this.data = data;
        initComponents();
        setOpaque(false);
        DecimalFormat df = new DecimalFormat(" #,##0.##");
        lbName.setText(data.getNom());
        lbValues.setText(df.format(data.getValeur()));
    }
