...
public class PanelDiagramme extends javax.swing.JPanel {

    private final List<ModelDiagramme> list;
    ...
    public void addItem(ModelDiagramme data) {
        list.add(data);
        repaint();
    }
