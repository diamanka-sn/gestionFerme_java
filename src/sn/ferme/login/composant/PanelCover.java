...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(description);
        description1 = new JLabel("Consomer à votre rythme, 100% naturel");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sn/ferme/login/icon/icons8_cow_breed_100px_3.png"))); // NOI18N
    ...
    private void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description.setText("KoSsam ferme");
                description1.setText("Consomer à votre rythme, 100% naturel");
