...
import sn.ferme.swing.ButtonCustom;
import sn.ferme.swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void createButtonMenu() {
        ...
        cmdMenu.setIcon(new ImageIcon(getClass().getResource("/sn/ferme/icon/menu.png")));
        cmdMenu.setBorder(new EmptyBorder(5, 12, 5, 12));
    }

    private void createButtonLogout() {
        cmdLogOut = new ButtonCustom();
        cmdLogOut.setIcon(new ImageIcon(getClass().getResource("/sn/ferme/icon/exit.png")));
    }
