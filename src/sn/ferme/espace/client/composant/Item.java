package sn.ferme.espace.client.composant;
...
public class Item extends javax.swing.JPanel {
    ...
    public void setData(ModelItem data) {
        ...
        DecimalFormat df = new DecimalFormat("F cfa###000");
    ...
    private void initComponents() {
        ...
        pic = new sn.ferme.espace.client.swing.PictureBox();
        ...
        pic.setImage(new javax.swing.ImageIcon(getClass().getResource("/sn/ferme/espace/client/image/img1.jpg"))); // NOI18N

        lbPrice.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        lbPrice.setForeground(new java.awt.Color(76, 76, 76));
        lbPrice.setText("Prix");
    ...
    private sn.ferme.espace.client.swing.PictureBox pic;
