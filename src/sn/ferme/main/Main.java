...
import sn.ferme.login.composant.PanelInscrirre_connexion;
...
public class Main extends javax.swing.JFrame {
    ...
    private PanelInscrirre_connexion loginAndRegister;
    ...
    private void init() {
        ...
        loginAndRegister = new PanelInscrirre_connexion(eventRegister);
    ...
    private void register() {
        ModelUtilisateur user = loginAndRegister.getUser();
